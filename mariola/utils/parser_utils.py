...
def get_parsed_arguments(
    first_arg_string: str, second_arg_string: str = None
    ...
    try:
        parser = argparse.ArgumentParser(
            description="A script that accepts one or two arguments."
        )
        parser.add_argument(
            "first_argument", type=str, help=f"A required argument. {first_arg_string}"
        )
        parser.add_argument(
            "second_argument",
            type=str,
