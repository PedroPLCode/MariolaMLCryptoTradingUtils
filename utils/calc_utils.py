...
def prepare_df(df=None, regresion=False, clasification=False, settings=None, training=False):
    ...
    try:
        ...
        for period in settings['general_timeperiods']:
            ...
            result[f'rsi_{period}_buy_signal'] = result[f'rsi_{period}'] < settings['rsi_buy_value']
            result[f'rsi_{period}_sell_signal'] = result[f'rsi_{period}'] > settings['rsi_sell_value']
            ...
            result[f'cci_{period}_buy_signal'] = result[f'cci_{period}'] < settings['cci_buy_value']
            result[f'cci_{period}_sell_signal'] = result[f'cci_{period}'] > settings['cci_sell_value']
            ...
            result[f'mfi_{period}_buy_signal'] = result[f'mfi_{period}'] < settings['mfi_buy_value']
            result[f'mfi_{period}_sell_signal'] = result[f'mfi_{period}'] > settings['mfi_sell_value']
        ...
        result[f'ema_{settings['ema_slow_timeperiod']}'] = talib.EMA(
            result['close'], 
